  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="w-[70%] text-2xl font-black text-white"
      >
      ...
      <motion.p
        ...
        className="w-[70%] mb-3 mt-3 text-white text-md"
      >
        {data.overview.slice(0, 260)}...
        <Link className="text-blue-400 hover:text-blue-300 transition duration-300">
          more
        </Link>
      </motion.p>
      ...
      >
        <Link className="bg-[#C61B1B] p-3 rounded text-white mt-4 inline-block hover:bg-[#ea8382] transition duration-300">
          Watch Trailer
        </Link>
      </motion.div>
    </motion.div>
